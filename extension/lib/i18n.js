...
const ZH = {
  ...
  fill_rejected: '这个编辑器不接受自动填入。译文已复制到剪贴板：先在输入框里全选（⌘A / Ctrl+A）删掉原文，再粘贴。',
  ...
  bubble_zh: '中文页面 · 无需翻译',
  bubble_chrome_translated: 'Chrome 已翻译此页 · 恢复原文后可用双语对照',
  bubble_page_now_target: '本页原文已切换为{lang} · 重复译文已收起',
  bubble_pack: '缺语言包 · 点击翻译并下载',
  bubble_google: '首次使用需下载谷歌翻译模型 · 点击开始',
  bubble_model_downloading: '正在下载谷歌翻译模型 {p}',
  bubble_model_failed: '谷歌模型下载失败 · 已改用本地引擎',
...
const EN = {
  ...
  fill_rejected: 'This editor rejects programmatic input. The translation is on your clipboard — select all (Ctrl/⌘+A), delete, then paste.',
  ...
  bubble_chrome_translated: 'Chrome already translated this page — restore the original to use bilingual view',
  bubble_page_now_target: 'This page switched to {lang} — duplicate translations removed',
  ...
  bubble_model_failed: 'Google model download failed — using local engine',
